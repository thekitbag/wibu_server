...
exports.checkCheckoutSessionStatus = void 0;
 ...
 */
const checkCheckoutSessionStatus = async (req, res) => {
    try {
        const { sessionId } = req.params;
        // Retrieve the checkout session from Stripe
        const stripeSession = await (0, paymentService_1.getStripeCheckoutSession)(sessionId);
...
exports.checkCheckoutSessionStatus = checkCheckoutSessionStatus;
