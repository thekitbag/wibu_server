...
describe('Stops API Endpoints', () => {
    ...
    beforeEach(async () => {
        // Clean up first
        await setup_1.prisma.stop.deleteMany();
        await setup_1.prisma.journey.deleteMany();
        // Then create a test journey for each test
        testJourney = await setup_1.prisma.journey.create({
    ...
    describe('POST /api/journeys/:journeyId/stops', () => {
        it('should create a new stop with valid data', async () => {
            ...
            const stopInDb = await setup_1.prisma.stop.findUnique({
        ...
        it('should automatically assign correct order for multiple stops', async () => {
            ...
            const response1 = await (0, supertest_1.default)(server_1.app)
                .post(`/api/journeys/${testJourney.id}/stops`)
                .send(stopData1)
                .expect(201);
            const response2 = await (0, supertest_1.default)(server_1.app)
                .post(`/api/journeys/${testJourney.id}/stops`)
                .send(stopData2)
                .expect(201);
    ...
    describe('Updated Journey Retrieval with Stops', () => {
        ...
        it('should return journey with stops ordered correctly', async () => {
            ...
            await setup_1.prisma.stop.createMany({
                data: [
                    {
                        title: 'Third Stop',
            ...
            response.body.stops.forEach((stop) => {
    ...
    describe('Integration: Create Journey, Add Stops, and Retrieve', () => {
        it('should create journey, add multiple stops, and retrieve complete journey', async () => {
            ...
            const journeyResponse = await (0, supertest_1.default)(server_1.app)
                .post('/api/journeys')
                .send(journeyData)
                .expect(201);
            ...
            const stop1Response = await (0, supertest_1.default)(server_1.app)
            ...
            const stop2Response = await (0, supertest_1.default)(server_1.app)
                .post(`/api/journeys/${journeyId}/stops`)
                .send(stop2Data)
                .expect(201);
